<template>
    <div>
        <h3>Lifecycle hook là quá trình khởi tạo đến khi kết thúc một instance, có bốn sự kiện chính và mỗi sự kiện được
            tách thành hai 2 hook được gọi trước và sau sự kiện đó.</h3>
        <ul>
